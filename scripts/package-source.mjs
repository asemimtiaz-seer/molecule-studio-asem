...
const flat = ["package.json", "package-lock.json", "tsconfig.json", "vite.config.ts", "postcss.config.mjs", "next.config.ts", "next.config.mjs", "README.md", "LICENSE", "THIRD_PARTY_NOTICES.md", "eslint.config.mjs", "components.json", "public/favicon.svg"];
const files = {};
